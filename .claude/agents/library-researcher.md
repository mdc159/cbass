...
description: "Use proactively when researching external libraries, APIs, SDKs, or third-party documentation. Triggers: 'research library', 'find documentation', 'API reference', 'how to use [library]', 'library best practices'"
model: sonnet

...
description: "Use proactively when analyzing codebases for patterns, coding standards, team conventions, architecture decisions, or project structure. Triggers: 'analyze codebase', 'find patterns', 'coding style', 'team standards', 'project structure'"
model: sonnet
